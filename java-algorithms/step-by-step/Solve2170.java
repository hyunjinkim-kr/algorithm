...
//
//      - 시작점이 다르고 겹치거나 걸쳐지는경우 : 새로운 선과 기준선의 범위를 합쳐 기준선을 설정한다.
//          e.g) 걸쳐짐 : 기준선(1,2) 새로운선(2,3) -> 기준선(1,3)
//          e.g) 겹쳐짐 : 기준선(1,3) 새로운선(2,4) -> 기준선(1,4)
//
//      - 나머지(시작점이 다르나, 겹치거나 걸치지 않는경우) : 기준선의 길이를 전체길이에 더하고, 새로운 선을 기준선으로 정한다.
